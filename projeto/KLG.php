...
<body >
  ...
  background-color: #5500FF;
	   ...
	   <?php include "barra.php" ?>
	 	<div class="container" id="Corpo" style="background-color:#fff; ">
	 		<br>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="xobx.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true">Saiba mais!</a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">V11.11 já está disponível para o game, veja os detalhes!</p>
      <a href="fortnite.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true">Saiba mais!</a>
    </div>
    <div class="card-footer">
  ...
  <div class="card">
    <img src="img/M.jpg" class="card-img-top" alt="Minecraft">
    <div class="card-body">
      ...
      <a href="minecraft.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true">Saiba mais!</a>
    </div>
    <div class="card-footer">
...
<div class="col-xs-6 col-md-6 col-lg-6">
  ...
  <br>
  <h1 style="text-align: center;">DEIXE UM COMENTÁRIO</h1>
